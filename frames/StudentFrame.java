...
{
	private JLabel stdIdLabel, stdNameLabel, crsNameLabel, crsIdLabel,loverLabel;
	private JTextField stdIdTF, stdNameTF, crsNameTF, crsIdTF,loverNameTF;
	...
	public StudentFrame(User user)
	{
		...
		stdIdLabel.setBounds(100,50,100,30);
		panel.add(stdIdLabel);
		
		stdIdTF = new JTextField();
		stdIdTF.setBounds(220,50,100,30);
		panel.add(stdIdTF);
		
		stdNameLabel = new JLabel("SName :");
		stdNameLabel.setBounds(100,100,100,30);
		panel.add(stdNameLabel);
		
		stdNameTF = new JTextField();
		stdNameTF.setBounds(220,100,100,30);
		panel.add(stdNameTF);
		
		crsIdLabel = new JLabel("CID: ");
		crsIdLabel.setBounds(100,150,100,30);
		panel.add(crsIdLabel);
		
		crsIdTF = new JTextField();
		crsIdTF.setBounds(220,150,100,30);
		panel.add(crsIdTF);
		
		crsNameLabel = new JLabel("CNAME: ");
		crsNameLabel.setBounds(100,200,100,30);
		panel.add(crsNameLabel);
		
		crsNameTF = new JTextField();
		crsNameTF.setBounds(220,200,100,30);
		panel.add(crsNameTF);
		
		loverLabel = new JLabel("Gf/Bf Name: ");
	    loverLabel.setBounds(100,250,100,30);
		panel.add(loverLabel);
		
		loverNameTF = new JTextField();
		loverNameTF.setBounds(220,250,100,30);
