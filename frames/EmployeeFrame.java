...
{
	private JLabel empIdLabel, empNameLabel, empDesignationLabel, empSalaryLabel,loverLabel;
	private JTextField empIdTF, empNameTF, empDesignationTF, empSalaryTF,loverNameTF;
	...
	public EmployeeFrame(User user)
	{
		...
		empDesignationLabel.setBounds(100,150,100,30);
		panel.add(empDesignationLabel);
		
		empDesignationTF = new JTextField();
		empDesignationTF.setBounds(220,150,100,30);
	...
	public void actionPerformed(ActionEvent ae)
	{
		...
		else if(command.equals(deleteBtn.getText()))
		{
			...
			SecurityRepo mr=new SecurityRepo();
			mr.deleteSecurity(empIdTF.getText());
