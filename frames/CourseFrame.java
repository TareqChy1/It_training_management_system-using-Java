...
public class CourseFrame extends JFrame implements ActionListener
{
	...
	public void actionPerformed(ActionEvent ae)
	{
		...
		else if(command.equals(updateBtn.getText()))
		{
			...
			Course course_1 = yr_1.searchCourse(crsIdTF.getText());
			Course f=new Course();
			...
			try{
			f.setCourseId(crsIdTF.getText());
			f.setCourseName(crsNameTF.getText());
			f.setCourseFee(Double.parseDouble(crsFeeTF.getText()));
			f.setDuration(crsdurationTF.getText());
