...
public class EmployeeHome extends JFrame implements ActionListener
{
	...
	private JButton manageEmpBtn,studentBtn,purchaseBtn,mangePayment,changePasswordBtn,updateBtn,CourseBtn,allStudentBtn,paymentBtb,logoutBtn,changeSecurityBtn;
	...
	public EmployeeHome(User user)
	{
		...
		changeSecurityBtn.setBounds(290, 428, 210, 35);
		changeSecurityBtn.setBackground(Color.decode("#6a2c70"));
		changeSecurityBtn.setForeground(Color.decode("#30e3ca"));
		...
		logoutBtn.setBounds(290, 478, 210, 35);
	...
	public void actionPerformed(ActionEvent ae)
	{
		...
		else if(command.equals(manageEmpBtn.getText()))
		{
			...
			PurchaseFrame pg=new PurchaseFrame(user);
		    pg.setVisible(true);
			this.setVisible(false);
			...
			ChangeSecurity pf=new ChangeSecurity(user);
			pf.setVisible(true);
			this.setVisible(false);
		}
