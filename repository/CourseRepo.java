...
public class CourseRepo implements ICourseRepo
{
	...
	public void updateInDB(Course e)
	{
		String query = "UPDATE course SET courseName = '"+e.getCourseName()+"', courseFee = "+e.getCourseFee()+",duration = '"+e.getDuration()+"'  WHERE courseId='"+e.getCourseId()+"'";
